...
// Source: internal/logic/manager/user.go
...
func (m *MockUser) Create(username, password string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUser) GetRepository() orm.UserRepository {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepository")
	ret0, _ := ret[0].(orm.UserRepository)
	return ret0
}
