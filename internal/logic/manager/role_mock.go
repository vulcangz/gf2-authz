...
// Source: internal/logic/manager/role.go
...
func (m *MockRole) Create(identifier string, policies []string) (*entity.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockRole) GetRepository() orm.RoleRepository {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepository")
	ret0, _ := ret[0].(orm.RoleRepository)
	return ret0
}
...
func (m *MockRole) Update(identifier string, policies []string) (*entity.Role, error) {
	m.ctrl.T.Helper()
