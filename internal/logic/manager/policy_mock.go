...
// Source: internal/logic/manager/policy.go
...
func (m *MockPolicy) Create(identifier string, resources, actions, attributeRules []string) (*entity.Policy, error) {
	m.ctrl.T.Helper()
...
func (m *MockPolicy) GetRepository() orm.PolicyRepository {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepository")
	ret0, _ := ret[0].(orm.PolicyRepository)
	return ret0
}
...
func (m *MockPolicy) Update(identifier string, resources, actions, attributeRules []string) (*entity.Policy, error) {
	m.ctrl.T.Helper()
