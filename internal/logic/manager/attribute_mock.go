...
// Source: internal/logic/manager/attribute.go
...
func (m *MockAttribute) GetRepository() orm.AttributeRepository {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepository")
	ret0, _ := ret[0].(orm.AttributeRepository)
	return ret0
}
...
func (m *MockAttribute) MapToSlice(attributes map[string]any) ([]*entity.Attribute, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "MapToSlice", attributes)
	ret0, _ := ret[0].([]*entity.Attribute)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
