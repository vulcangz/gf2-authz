...
// Source: internal/logic/manager/audit.go
...
func (m *MockAudit) BatchAdd(audits []*entity.Audit) error {
	m.ctrl.T.Helper()
...
func (m *MockAudit) GetRepository() orm.AuditRepository {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepository")
	ret0, _ := ret[0].(orm.AuditRepository)
	return ret0
}
